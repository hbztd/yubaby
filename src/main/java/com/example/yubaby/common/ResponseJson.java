...
public class ResponseJson<T> implements Serializable {
    ...
    public static  ResponseJson createDefaultError(){
        return new ResponseJson(Const.ResponseCode.ERROR.getCode(), Const.ResponseCode.ERROR.getDesc());
    }
    ...
    public static <T> ResponseJson createByCustom(int status, String msg, T data) {
